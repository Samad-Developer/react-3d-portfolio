  ...
  return (
    <section className='relative w-full h-screen mx-auto'>
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText}`}>Hi, I'm <span className='text-[#915eff]'> Samad </span></h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>I develope Mern stack Web Applications</p>
        </div>
      </div>
      <ComputersCanvas />
